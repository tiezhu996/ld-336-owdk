...
type OverviewResp struct {
	...
	CalibrationExpired     int64            `json:"calibration_expired"`
	CalibrationUnqualified int64            `json:"calibration_unqualified"`
	CalibrationDueTotal    int64            `json:"calibration_due_total"`
